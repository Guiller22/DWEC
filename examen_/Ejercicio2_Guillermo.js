...
var solicitudesParseadas = JSON.parse(jsonSolicitudes);
var ERFecha=/^dd-mm-yyyy$/;

var fecha=solicitudesParseadas.fechanac;
var notaExp=solicitudesParseadas.notaExpediente;


for (let i = 0; i < solicitudesParseadas.length; i++) {
        indice=-1;
        if (ERFecha.test ? indice=2 : a=0) {
